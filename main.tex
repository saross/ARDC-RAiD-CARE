...
\begin{tikzpicture}[
    ...
    core/.style = {box, fill=ARDCBlue, text=white, font=\sffamily\bfseries},
    extended/.style = {box, fill=ARDCPink, text=white, font=\sffamily\bfseries},
    local/.style = {box, fill=ARDCPurple, text=white, font=\sffamily\bfseries},
    item/.style = {box, fill=ARDCYellow, text=DarkGrey},
    group/.style = {draw=DarkGrey, dashed, inner sep=12pt, rounded corners=5pt},
    tk/.style = {draw=DarkGrey, line width=1pt, text=DarkGrey, font=\bfseries}
]
...
\node[extended, below left=2.5cm and 5cm of raid] (extended) {Extended};
\node[local, below right=2.5cm and 5cm of raid] (local) {Local};
...
% Caption
\begin{center}
\captionof{figure}{RAiD linking project components (Local Contexts TK Labels and Notices highlighted}
\end{center}
