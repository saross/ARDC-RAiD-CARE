...
\vspace{-2cm}  % Adjust this value as needed
...
\vspace{2cm}  % Increase this value to add more space after the figure
\end{wrapfigure}
...
\begin{tikzpicture}[
    ...
    box/.style = {rectangle, minimum width=3cm, minimum height=0.8cm, text centered, font=\sffamily\small},
    main/.style = {box, fill=DarkGrey, text=white, font=\sffamily\bfseries},
    core/.style = {box, fill=ARDCBlue, text=white},
    extended/.style = {box, fill=ARDCPink, text=white},
    local/.style = {box, fill=ARDCPurple, text=white},
    item/.style = {box, fill=ARDCYellow, text=DarkGrey},
    arrow/.style = {->, >=stealth, thick, DarkGrey},
    group/.style = {draw=DarkGrey, dashed, inner sep=10pt, rounded corners}
]

% Main node
\node[main] (raid) {RAiD Metadata};

% Three main categories
\node[core, below=of raid] (core) {Core};
\node[extended, below left=2cm and 4cm of raid] (extended) {Extended};
\node[local, below right=2cm and 4cm of raid] (local) {Local};
...
\node[item, below=of c5] (c6) {Organizations};
...
\node[item, below=of e4] (e5) {TK Labels};
\node[item, below=of e5] (e6) {TK Notices};
...
% Caption
\node[below=0.1cm of c7, text width=24cm, align=center] {\captionof{figure}{RAiD linking project components}};
...
\large{
\begin{enumerate}
\item Carroll, S. R., Garba, I., Figueroa-Rodríguez, O. L., Holbrook, J., Lovett, R., Materechera, S., Parsons, M., Raseroka, K., Rodriguez-Lonebear, D., Rowe, R., Sara, R., Walker, J. D., Anderson, J., \& Hudson, M. (2020). The CARE Principles for Indigenous Data Governance. Data Science Journal, 19(1), 43. https://doi.org/10.5334/dsj-2020-043
\end{enumerate}
}
